...
/*	for(int i=0;i<MERGED_MAX;i++)
	...
	disableCxtChange = 0;
	nestingDepth=0;
	memset(ctxarray,0,sizeof(int)*CTXCOUNT);
	guard_ctx=0;
//	guard_mergedid=0;
	currentCtx = 0;
...
extern "C" 
void* QproMalloc (size_t size, InstrID instrId){
...
extern "C" 
void* QproCalloc (size_t num, size_t size, InstrID instrId){
...
extern "C" 
void* QproRealloc (void* addr, size_t size, InstrID instrId){
  void* naddr = NULL;
